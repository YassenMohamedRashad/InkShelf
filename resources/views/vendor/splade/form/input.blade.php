    ...
    <label class="block">
        ...
        <div class="flex rounded-md border border-gray-300 shadow-sm">
            ...
            <input {{ $attributes->except(['v-if', 'v-show', 'v-for', 'class'])->class([
                'text-black block w-full border-0 focus:border-indigo-300 focus:ring focus:ring-orange-color focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed',
